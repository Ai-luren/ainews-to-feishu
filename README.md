...
```
┌──────────────────────────────────────────────────────────┐
│juya　AI早报　·　2026-06-22                                │
├──────────────────────────────────────────────────────────┤
│                                                          │
│【要闻】                                                  │
│・OpenAI发布GPT-5支持多模态推理                           │
│・Google　Gemini2.0全面对外开放                           │
│・Anthropic　Claude4支持长上下文                          │
│                                                          │
│──────────────────────────────────────────────────────────│
│                                                          │
│【大模型与基础模型】                                      │
│・Meta开源Llama4　70B参数                                 │
│・Mistral　Large2　128K上下文                             │
│                                                          │
│──────────────────────────────────────────────────────────│
│                                                          │
│【查看完整日报】　【B站】                                 │
